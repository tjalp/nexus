										...
										selections: [
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'GeneralAttachment' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'lastKnownName' } }
													]
												}
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'PunishmentAttachment' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{
															kind: 'Field',
															name: { kind: 'Name', value: 'punishments' },
															selectionSet: {
																kind: 'SelectionSet',
																selections: [
